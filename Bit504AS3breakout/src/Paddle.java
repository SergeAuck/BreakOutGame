...
public class Paddle extends Sprite {
	...
	public Paddle() {
		...
		// TODO: Set width to Settings.PADDLE_HEIGHT  height not width
	...
	public void update() {
		...
		if (x  >= Settings.WINDOW_WIDTH -  Settings.PADDLE_WIDTH -15) { //extra -15 to stop paddle exactly on the border
			x = Settings.WINDOW_WIDTH - Settings.PADDLE_WIDTH - 15;
		}
		if (x <= 0) {
			x = 0;
		}
