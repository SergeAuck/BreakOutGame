...
public class BreakoutPanel extends JPanel implements ActionListener, KeyListener {
	...
	private Brick[] bricks; //array in here?
	...
	private void gameOver() {
		...
		screenMessage = "This Game is Over";
		stopGame();
	}
	
	private void gameWon() {
		// TODO: Set screen message
		screenMessage = "You won! Well done!";
		stopGame();
	}
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.VK_LEFT) {
			paddle.setXVelocity(-5); //do we need to guess the speed? Cant find constant for speed. Add to setting speed of paddle?
		}
